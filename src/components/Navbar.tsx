...
export default function Navbar() {
  ...
  const tabs = [
    { id: "homes", label: "Homes", emoji: "🏠", path: "/" },
    { id: "experiences", label: "Experiences", emoji: "🎈", isNew: true, path: "/room" },
    { id: "services", label: "Services", emoji: "🛎️", isNew: true, path: "/room" },
  ];
  ...
  return (
    <nav className="w-full bg-[#1A1A1A] border-b border-gray-800 sticky top-0 z-50 font-sans px-6 transition-colors">
      <div className="max-w-[1280px] mx-auto h-20 flex items-center justify-between gap-4">
        ...
        {/* 1. Logo - Pakai Link agar bisa diklik balik ke Home */}
        <Link to="/" className="flex items-center text-[#FF385C] shrink-0">
        ...
        <div className="flex items-center gap-1 shrink-0">
          <a href="#" className="hidden lg:block text-sm font-semibold text-gray-200 px-4 py-2.5 rounded-full hover:bg-white/10 transition-colors whitespace-nowrap">
            Menjadi Tuan Rumah
          </a>
